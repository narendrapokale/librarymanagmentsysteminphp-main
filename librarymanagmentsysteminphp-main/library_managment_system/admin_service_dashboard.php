...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <div>Branch:<input type="radio" name="branch" value="other"/>other<input type="radio" name="branch" value="BSIT"/>IT<div style="margin-left:80px"><input type="radio" name="branch" value="BSCS"/>CS<input type="radio" name="branch" value="BSSE"/>EXTC</div>
            </div>   
